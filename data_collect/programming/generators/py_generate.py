...
from .generator_utils import generate_ALGO, generate_plan, evaluation_plan, generate_code, generate_analysis, generate_program_with_print,generate_correct_program, generate_explain, evaluation_plan_check
...
class PyGenerator:
    def ALGO_generation(self, prompt: str, Correct_Program: str, entry: str, model: ModelBase, messages: List[
        Message], dataset_type: str = "") -> str:
        prompts = prompt_words()
        ALGO, message = generate_ALGO(
            prompt=prompt,
            Correct_Program=Correct_Program,
            ALGO_system=prompts.PY_ALGO_ANALYSIS_SYSTEM,
            ALGO_user=prompts.PY_ALGO_ANALYSIS_USER,
            ALGO_examples=prompts.PY_ALGO_ANALYSIS_EXAMPLES,
            entry=entry,
            model=model,
            messages=messages,
    ...
    def plan_generation(self, prompt: str, entry: str, algorithm: str, strategy: str, complexity: str, Correct_Program: str,  model: ModelBase, messages: List[
        Message], dataset_type: str = "") -> str:
        prompts = prompt_words()
    ...
    def program_analysis(self, prompt: str, cur_func_impl: str,correct_Program:str, failed_tests: str, printed_output:str, model: ModelBase, messages: List[
        Message], dataset_type: str = "") -> str:
        prompts = prompt_words()
    ...
    def correct_program(self, prompt: str, cur_func_impl: str, error_analysis:str, incorrect_history_prompt:str, model: ModelBase, messages: List[
        Message], dataset_type: str = "") -> str:
        prompts = prompt_words()
